...
#    And I should see text that reads "Here, you will find information about EVBP's entire discography,including summaries behind each release, interesting tidbits, and possibly clues about other things..."
#    And the "first" release tile will be "Only Criminals Get Caught"
#    And the "second" release tile will be "The X of Art (Deluxe Edition)"
...
#    Given I am on the music page
#    When I see the "Only Criminals Get Caught" release tile
#    Then I should see the cover image for "Only Criminals Get Caught"
#    And I should the release date as "January 20, 2025"
#    And I should see the album credits "Produced and mixed by EVBP. Mastered by Peter Bishop. Artwork by Jevena Nevetic."
#    And I should see the tracklist for "Only Criminals Get Caught"
